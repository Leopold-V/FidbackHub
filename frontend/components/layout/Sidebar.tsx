            ...
            >
              <a
                className={classNames(
                  item.current ? 'bg-main text-mainText' : 'text-muted hover:bg-secondaryBackground hover:text-mainText',
              ...
              <span 
                className={classNames(
                  item.current ? 'visible' : 'collapse',
                  'text-main bg-white rounded-full p-2'
                )}
              >
                <ArrowRightIcon 
                  className="h-5 w-5"
